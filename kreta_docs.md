...
- [Atlantisz-Proxy / Kréta docs](#atlantisz-proxy--kréta-docs)
  - [Mobilverzió lekérése](#mobilverzió-lekérése)
  - [API-k lekérése](#api-k-lekérése)
  - [Iskolák listájának lekérése](#iskolák-listájának-lekérése)
  - [Bearer token lekérése](#bearer-token-lekérése)
  - [Bearer token frissítése](#bearer-token-frissítése)
  - [Intézmény információ lekérése](#intézmény-információ-lekérése)
  - [Diák adatainak lekérése](#diák-adatainak-lekérése)
  - [Események lekérése](#események-lekérése)
  - [Órarend lekérése](#órarend-lekérése)
  - [Bejelentett számonkérések lekérése](#bejelentett-számonkérések-lekérése)
  - [Postaláda elemek lekérése](#postaláda-elemek-lekérése)
    - [Specifikus postaláda elem lekérése](#specifikus-postaláda-elem-lekérése)
  - [Tantárgyi átlagok lekérése](#tantárgyi-átlagok-lekérése)
  - [Tanári házifeladatok](#tanári-házifeladatok)
    - [Tanári házifeladatok lekérése](#tanári-házifeladatok-lekérése)
    - [Specifikus tanári házifeladat lekérése](#specifikus-tanári-házifeladat-lekérése)
    - [Tanári házifeladatok megoldottnak jelölése](#tanári-házifeladatok-megoldottnak-jelölése)
